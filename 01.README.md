...
✅ STEP 4: ERPNext Docker repo clone
git clone https://github.com/frappe/frappe_docker
cd frappe_docker
...
docker ps
✅ STEP 6: Site create करना (MAIN STEP)

अब तुम्हें site create करनी है calcoerp.com

👉 पहले container के अंदर जाओ:

docker exec -it frappe_docker-backend-1 bash
🔥 STEP 6.1: Bench directory check
cd /home/frappe/frappe-bench
🔥 STEP 6.2: Site create command
bench new-site calcoerp.com

👉 यह command automatically:

MySQL database create करेगा
Admin password set करेगा
Configuration setup करेगा
अगर password पूछे:
MySQL root password (docker default)
Site admin password (set your own)
bench --site calcoerp.com install-app erpnext
...
# bench new-site calcoerp.com --admin-password=admin --mariadb-root-password=admin --install-app erpnext --set-default
# FRAPPE_SITE_NAME_HEADER: calcoerp.com

docker compose -f pwd.yml up -d
# skip kar sakte hai agar PWD or example.env mai okk hai 
